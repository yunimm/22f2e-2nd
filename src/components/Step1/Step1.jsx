		...
		<>
			<div className="step1-main-wrapper__content">
				...
				<div className="relative h-[538px] rounded-[10px] border bg-[#E7E9EA] p-2.5">
					<span className="absolute right-2.5 rounded-md bg-black py-1.5 px-3 font-medium text-white">共三頁</span>
...
const IsEmptyFile = ({onUploadFile}) => {
	return (
		<>
			<div className="step1-main-wrapper__content">
...
const Step1 = ({uploadFile, step, onUploadFile}) => {
	if (step > 1) return null;
	return (
		<>
			<main className="step1-main-wrapper">
				{uploadFile === null && <IsEmptyFile onUploadFile={onUploadFile} />}
